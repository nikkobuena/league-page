/*   STEP 1   */
export const leagueID = "667961138331357184"; // your league ID
export const leagueName = "SF Dynasty League"; // your league name
export const dues = 5; // (optional) used in template constitution page
export const dynasty = true; // true for dynasty leagues, false for redraft and keeper

/*   STEP 2   */
export const homepageText = `
  <p>Founded in 2021, the SF league began as a league amongst students of Saint Francis High School. Each year, team managers compete to win the SF Cup and avoid getting last place.</p>
  <p>2021 is the inagural season, so we'll have to wait and see which managers compete for the title and which managers start rebuilding after this season. Winning includes bragging rights and the ability to send obnoxious texts to everyone else in the league for the next year.</p>
`;
...
export const managers = [
    {
      ...
      "bio": "Comissioner soon to be 2021 league champ",
      "photo": "/managers/Nicholas.png", // square ratio recommended (no larger than 500x500)
      ...
      "philosophy": "Develop young players into future superstars",
      "tradingScale": 7, // 1 - 10
    ...
    },
  {
      ...
      "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "California", // (optional)
      "bio": "Winning games and slinging cum baby, that's what it be",
      "photo": "/managers/Jarett.png", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2018, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "den", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
      ...
      "philosophy": "Win win win no matter what, got winning on my mind I can never get enough. Every time I join a league everybody's head goes down and they stay ther, and they stay there, up, down, up down, up, down, cause all I do is win, , win, win",
      "tradingScale": 5, // 1 - 10
      "preferredContact": "Snapchat", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
  {
    ...
    },
  {
      ...
      "favoritePlayer": 20889, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Win",
      "tradingScale": 4, // 1 - 10
    ...
    },
  {
      ...
      "location": "California", // (optional)
      "bio": "Awesome",
      "photo": "/managers/Franck.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2021, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "lac", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
      ...
      "favoritePlayer": 19781, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "RB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Sure",
      "tradingScale": 3, // 1 - 10
